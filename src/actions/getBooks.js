import { GET_BOOKS, ADD_TO_CART, REMOVE_FROM_CART, GET_BOOKS_SUCCESS, GET_BOOKS_ERROR, GET_PAGINATED_BOOKS, GET_QUERIED_BOOKS } from '../constants';
...
export const getPaginatedBooksAction = () => ({
...
//moze podzielic na foldery cart i books ?
